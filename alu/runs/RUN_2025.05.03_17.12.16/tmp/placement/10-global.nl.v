module alu (A,
 ...
 sky130_fd_sc_hd__buf_1 _248_ (.A(A[0]),
    .X(_176_));
 sky130_fd_sc_hd__or2_2 _249_ (.A(opcode[0]),
    .B(opcode[1]),
    .X(_180_));
 sky130_fd_sc_hd__or2_2 _250_ (.A(opcode[2]),
    .B(_180_),
    .X(_181_));
 sky130_fd_sc_hd__buf_1 _251_ (.A(B[0]),
    .X(_182_));
 sky130_fd_sc_hd__buf_1 _252_ (.A(_182_),
    .X(_183_));
 sky130_fd_sc_hd__or2_2 _253_ (.A(_176_),
    .B(_183_),
    .X(_184_));
 sky130_fd_sc_hd__nand2_2 _254_ (.A(opcode[0]),
    .B(opcode[1]),
    .Y(_185_));
 sky130_fd_sc_hd__inv_2 _255_ (.A(opcode[2]),
    .Y(_186_));
 sky130_fd_sc_hd__nand2_2 _256_ (.A(opcode[0]),
    .B(_186_),
    .Y(_187_));
 ...
 sky130_fd_sc_hd__nor2_2 _258_ (.A(_186_),
    .B(_180_),
    .Y(_189_));
 sky130_fd_sc_hd__nor2_2 _259_ (.A(opcode[2]),
    .B(_185_),
    .Y(_190_));
 sky130_fd_sc_hd__o211a_2 _260_ (.A1(_189_),
    .A2(_190_),
    .B1(_176_),
    .C1(_183_),
    .X(_191_));
 ...
 sky130_fd_sc_hd__a2bb2o_2 _262_ (.A1_N(_176_),
    ...
    .B2(_192_),
    .X(out[0]));
 sky130_fd_sc_hd__buf_1 _263_ (.A(A[1]),
    .X(_193_));
 sky130_fd_sc_hd__nor2_2 _264_ (.A(opcode[2]),
    .B(_180_),
    .Y(_194_));
 sky130_fd_sc_hd__buf_1 _265_ (.A(_194_),
    .X(_195_));
 sky130_fd_sc_hd__buf_1 _266_ (.A(B[1]),
    .X(_196_));
 sky130_fd_sc_hd__buf_1 _267_ (.A(_196_),
    .X(_197_));
 sky130_fd_sc_hd__nor2_2 _268_ (.A(opcode[1]),
    .B(_187_),
    .Y(_198_));
 sky130_fd_sc_hd__or3b_2 _269_ (.A(opcode[0]),
    .B(opcode[2]),
    .C_N(opcode[1]),
    .X(_199_));
 sky130_fd_sc_hd__buf_1 _270_ (.A(_199_),
    .X(_200_));
 ...
 sky130_fd_sc_hd__o22a_2 _272_ (.A1(_193_),
    ...
    .B2(_201_),
    .X(_202_));
 sky130_fd_sc_hd__and3_2 _273_ (.A(opcode[2]),
    .B(_180_),
    .C(_185_),
    .X(_203_));
 sky130_fd_sc_hd__or2b_2 _274_ (.A(A[0]),
    .B_N(_183_),
    .X(_204_));
 sky130_fd_sc_hd__nand3b_2 _275_ (.A_N(opcode[0]),
    .B(opcode[1]),
    .C(opcode[2]),
    .Y(_205_));
 ...
 sky130_fd_sc_hd__a22o_2 _283_ (.A1(_183_),
    ...
    .B2(_176_),
    .X(_213_));
 sky130_fd_sc_hd__and3b_2 _284_ (.A_N(_212_),
    .B(_189_),
    .C(_213_),
    .X(_214_));
 ...
 sky130_fd_sc_hd__o2bb2a_2 _287_ (.A1_N(_193_),
    ...
    .B2(_216_),
    .X(out[1]));
 sky130_fd_sc_hd__buf_1 _288_ (.A(A[2]),
    .X(_217_));
 sky130_fd_sc_hd__buf_1 _289_ (.A(B[2]),
    .X(_218_));
 sky130_fd_sc_hd__nand2_2 _290_ (.A(_176_),
    .B(_218_),
    .Y(_219_));
 sky130_fd_sc_hd__and3_2 _291_ (.A(_193_),
    .B(_197_),
    .C(_217_),
    .X(_220_));
 ...
 sky130_fd_sc_hd__o21ai_2 _296_ (.A1(_212_),
    ...
    .B1(_189_),
    .Y(_225_));
 sky130_fd_sc_hd__nor2_2 _297_ (.A(_224_),
    .B(_225_),
    .Y(_226_));
 ...
 sky130_fd_sc_hd__o21a_2 _303_ (.A1(_229_),
    ...
    .B1(_203_),
    .X(_232_));
 sky130_fd_sc_hd__nand2_2 _304_ (.A(A[2]),
    .B(B[2]),
    .Y(_233_));
 sky130_fd_sc_hd__and2b_2 _305_ (.A_N(_200_),
    .B(_233_),
    .X(_234_));
 sky130_fd_sc_hd__o22a_2 _306_ (.A1(_217_),
    .A2(_218_),
    .B1(_198_),
    .B2(_234_),
    .X(_235_));
 sky130_fd_sc_hd__a31o_2 _307_ (.A1(_217_),
    ...
    .B1(_235_),
    .X(_236_));
 sky130_fd_sc_hd__a211o_2 _308_ (.A1(_231_),
    .A2(_232_),
    .B1(_236_),
    .C1(_195_),
    .X(_237_));
 sky130_fd_sc_hd__o2bb2a_2 _309_ (.A1_N(_217_),
    ...
    .B2(_237_),
    .X(out[2]));
 sky130_fd_sc_hd__buf_1 _310_ (.A(A[3]),
    .X(_238_));
 sky130_fd_sc_hd__and2_2 _311_ (.A(_217_),
    .B(_228_),
    .X(_239_));
 sky130_fd_sc_hd__a21o_2 _312_ (.A1(_229_),
    ...
    .B1(_239_),
    .X(_240_));
 sky130_fd_sc_hd__buf_1 _313_ (.A(B[3]),
    .X(_241_));
 ...
 sky130_fd_sc_hd__and3_2 _318_ (.A(_240_),
    ...
    .C(_245_),
    .X(_246_));
 sky130_fd_sc_hd__a21o_2 _319_ (.A1(_244_),
    .A2(_245_),
    .B1(_240_),
    .X(_247_));
 ...
 sky130_fd_sc_hd__nand2_2 _321_ (.A(_176_),
    .B(_241_),
    .Y(_001_));
 sky130_fd_sc_hd__nand2_2 _322_ (.A(A[1]),
    .B(_218_),
    .Y(_002_));
 sky130_fd_sc_hd__and4_2 _323_ (.A(B[0]),
    .B(B[1]),
    .C(A[2]),
    .D(A[3]),
    .X(_003_));
 sky130_fd_sc_hd__a22oi_2 _324_ (.A1(_196_),
    .A2(A[2]),
    .B1(_238_),
    .B2(_182_),
    .Y(_004_));
 ...
 sky130_fd_sc_hd__and4_2 _327_ (.A(_182_),
    ...
    .D(_217_),
    .X(_007_));
 sky130_fd_sc_hd__a31o_2 _328_ (.A1(A[0]),
    .A2(_218_),
    .A3(_221_),
    .B1(_007_),
    .X(_008_));
 ...
 sky130_fd_sc_hd__nand2_2 _333_ (.A(_224_),
    .B(_012_),
    .Y(_013_));
 sky130_fd_sc_hd__or2_2 _334_ (.A(_224_),
    .B(_012_),
    .X(_014_));
 sky130_fd_sc_hd__a21oi_2 _335_ (.A1(_238_),
    ...
    .B1(_200_),
    .Y(_015_));
 sky130_fd_sc_hd__o22a_2 _336_ (.A1(_238_),
    .A2(_241_),
    .B1(_198_),
    .B2(_015_),
    .X(_016_));
 sky130_fd_sc_hd__a311o_2 _337_ (.A1(_238_),
    .A2(_241_),
    .A3(_190_),
    .B1(_195_),
    .C1(_016_),
    .X(_017_));
 sky130_fd_sc_hd__a31o_2 _338_ (.A1(_189_),
    .A2(_013_),
    .A3(_014_),
    .B1(_017_),
    .X(_018_));
 sky130_fd_sc_hd__o2bb2a_2 _339_ (.A1_N(_238_),
    ...
    .B2(_018_),
    .X(out[3]));
 sky130_fd_sc_hd__buf_1 _340_ (.A(A[4]),
    .X(_019_));
 ...
 sky130_fd_sc_hd__buf_1 _342_ (.A(B[4]),
    .X(_021_));
 sky130_fd_sc_hd__a22o_2 _343_ (.A1(A[1]),
    .A2(B[3]),
    .B1(_021_),
    .B2(A[0]),
    .X(_022_));
 sky130_fd_sc_hd__and4_2 _344_ (.A(A[0]),
    .B(A[1]),
    .C(B[3]),
    .D(B[4]),
    .X(_023_));
 ...
 sky130_fd_sc_hd__and2_2 _346_ (.A(_022_),
    .B(_024_),
    .X(_025_));
 sky130_fd_sc_hd__and4_2 _347_ (.A(B[0]),
    .B(B[1]),
    .C(A[3]),
    .D(A[4]),
    .X(_026_));
 sky130_fd_sc_hd__a22oi_2 _348_ (.A1(B[1]),
    .A2(A[3]),
    .B1(A[4]),
    .B2(B[0]),
    .Y(_027_));
 ...
 sky130_fd_sc_hd__o22a_2 _370_ (.A1(_019_),
    ...
    .B2(_048_),
    .X(_049_));
 sky130_fd_sc_hd__a311o_2 _371_ (.A1(_019_),
    .A2(_021_),
    .A3(_190_),
    .B1(_194_),
    .C1(_049_),
    .X(_050_));
 sky130_fd_sc_hd__a31o_2 _372_ (.A1(_203_),
    .A2(_046_),
    .A3(_047_),
    .B1(_050_),
    .X(_051_));
 sky130_fd_sc_hd__o2bb2a_2 _373_ (.A1_N(_019_),
    ...
    .B2(_051_),
    .X(out[4]));
 sky130_fd_sc_hd__buf_1 _374_ (.A(A[5]),
    .X(_052_));
 ...
 sky130_fd_sc_hd__a21o_2 _376_ (.A1(_021_),
    ...
    .B1(_040_),
    .X(_054_));
 sky130_fd_sc_hd__xnor2_2 _377_ (.A(B[5]),
    .B(_054_),
    .Y(_055_));
 sky130_fd_sc_hd__and2_2 _378_ (.A(_052_),
    .B(_055_),
    .X(_056_));
 sky130_fd_sc_hd__nor2_2 _379_ (.A(_052_),
    .B(_055_),
    .Y(_057_));
 ...
 sky130_fd_sc_hd__a22o_2 _383_ (.A1(_196_),
    ...
    .B2(B[0]),
    .X(_061_));
 sky130_fd_sc_hd__and2_2 _384_ (.A(B[2]),
    .B(A[3]),
    .X(_062_));
 ...
 sky130_fd_sc_hd__a21o_2 _389_ (.A1(_063_),
    ...
    .B1(_065_),
    .X(_067_));
 sky130_fd_sc_hd__nand2_2 _390_ (.A(A[0]),
    .B(B[5]),
    .Y(_068_));
 sky130_fd_sc_hd__and4_2 _391_ (.A(A[1]),
    .B(A[2]),
    .C(B[3]),
    .D(B[4]),
    .X(_069_));
 sky130_fd_sc_hd__a22o_2 _392_ (.A1(A[2]),
    .A2(B[3]),
    .B1(B[4]),
    .B2(A[1]),
    .X(_070_));
 ...
 sky130_fd_sc_hd__a21o_2 _397_ (.A1(_025_),
    ...
    .B1(_031_),
    .X(_075_));
 sky130_fd_sc_hd__and3_2 _398_ (.A(_073_),
    .B(_074_),
    .C(_075_),
    .X(_076_));
 ...
 sky130_fd_sc_hd__a311o_2 _407_ (.A1(_052_),
    ...
    .C1(_084_),
    .X(_085_));
 sky130_fd_sc_hd__a31o_2 _408_ (.A1(_189_),
    .A2(_081_),
    .A3(_082_),
    .B1(_085_),
    .X(_086_));
 sky130_fd_sc_hd__a21oi_2 _409_ (.A1(_203_),
    .A2(_059_),
    .B1(_086_),
    .Y(_087_));
 ...
 sky130_fd_sc_hd__nand3_2 _411_ (.A(_073_),
    ...
    .C(_075_),
    .Y(_088_));
 sky130_fd_sc_hd__a31o_2 _412_ (.A1(A[0]),
    .A2(B[5]),
    .A3(_070_),
    .B1(_069_),
    .X(_089_));
 sky130_fd_sc_hd__and3_2 _413_ (.A(A[0]),
    .B(B[6]),
    .C(_089_),
    .X(_090_));
 ...
 sky130_fd_sc_hd__a22o_2 _417_ (.A1(_196_),
    ...
    .B2(_182_),
    .X(_094_));
 sky130_fd_sc_hd__and2_2 _418_ (.A(B[2]),
    .B(_019_),
    .X(_095_));
 ...
 sky130_fd_sc_hd__nand2_2 _424_ (.A(_193_),
    .B(B[5]),
    .Y(_101_));
 sky130_fd_sc_hd__and3_2 _425_ (.A(_238_),
    .B(B[3]),
    .C(B[4]),
    .X(_102_));
 sky130_fd_sc_hd__a22o_2 _426_ (.A1(A[3]),
    .A2(B[3]),
    .B1(_021_),
    .B2(A[2]),
    .X(_103_));
 ...
 sky130_fd_sc_hd__a21bo_2 _440_ (.A1(_081_),
    ...
    .B1_N(_189_),
    .X(_117_));
 sky130_fd_sc_hd__or2_2 _441_ (.A(_115_),
    .B(_117_),
    .X(_118_));
 sky130_fd_sc_hd__a21o_2 _442_ (.A1(_053_),
    ...
    .B1(_056_),
    .X(_119_));
 sky130_fd_sc_hd__or2_2 _443_ (.A(B[5]),
    .B(_054_),
    .X(_120_));
 sky130_fd_sc_hd__nand2_2 _444_ (.A(_205_),
    .B(_120_),
    .Y(_121_));
 sky130_fd_sc_hd__xor2_2 _445_ (.A(B[6]),
    .B(_121_),
    .X(_122_));
 sky130_fd_sc_hd__xor2_2 _446_ (.A(A[6]),
    .B(_122_),
    .X(_123_));
 sky130_fd_sc_hd__nand2_2 _447_ (.A(_119_),
    .B(_123_),
    .Y(_124_));
 sky130_fd_sc_hd__o21a_2 _448_ (.A1(_119_),
    .A2(_123_),
    .B1(_203_),
    .X(_125_));
 sky130_fd_sc_hd__a21oi_2 _449_ (.A1(A[6]),
    .A2(B[6]),
    .B1(_200_),
    .Y(_126_));
 sky130_fd_sc_hd__o22a_2 _450_ (.A1(A[6]),
    .A2(B[6]),
    .B1(_198_),
    .B2(_126_),
    .X(_127_));
 sky130_fd_sc_hd__a311o_2 _451_ (.A1(A[6]),
    .A2(B[6]),
    .A3(_190_),
    .B1(_195_),
    .C1(_127_),
 ...
 sky130_fd_sc_hd__a21oi_2 _452_ (.A1(_124_),
    ...
    .B1(_128_),
    .Y(_129_));
 sky130_fd_sc_hd__a22oi_2 _453_ (.A1(A[6]),
    .A2(_195_),
    .B1(_118_),
    .B2(_129_),
    .Y(out[6]));
 sky130_fd_sc_hd__and2_2 _454_ (.A(A[6]),
    .B(_122_),
    .X(_130_));
 sky130_fd_sc_hd__a21oi_2 _455_ (.A1(_119_),
    ...
    .B1(_130_),
    .Y(_131_));
 sky130_fd_sc_hd__o21ai_2 _456_ (.A1(B[6]),
    .A2(_120_),
    .B1(_205_),
    .Y(_132_));
 sky130_fd_sc_hd__nand2_2 _457_ (.A(A[7]),
    .B(B[7]),
    .Y(_133_));
 sky130_fd_sc_hd__or2_2 _458_ (.A(A[7]),
    .B(B[7]),
    .X(_134_));
 ...
 sky130_fd_sc_hd__and2b_2 _461_ (.A_N(_135_),
    .B(_132_),
    .X(_137_));
 sky130_fd_sc_hd__nor2_2 _462_ (.A(_136_),
    .B(_137_),
    .Y(_138_));
 ...
 sky130_fd_sc_hd__o311a_2 _464_ (.A1(_131_),
    ...
    .C1(_203_),
    .X(_140_));
 sky130_fd_sc_hd__a211o_2 _465_ (.A1(_088_),
    .A2(_079_),
    .B1(_111_),
    .C1(_112_),
    .X(_141_));
 ...
 sky130_fd_sc_hd__o211ai_2 _471_ (.A1(_144_),
    ...
    .C1(_143_),
    .Y(_147_));
 sky130_fd_sc_hd__a22o_2 _472_ (.A1(_241_),
    .A2(_019_),
    .B1(_146_),
    .B2(_147_),
    .X(_148_));
 ...
 sky130_fd_sc_hd__nand3_2 _478_ (.A(_152_),
    ...
    .C(_149_),
    .Y(_154_));
 sky130_fd_sc_hd__and4_2 _479_ (.A(A[2]),
    .B(A[3]),
    .C(B[3]),
    .D(_021_),
    .X(_155_));
 sky130_fd_sc_hd__a31o_2 _480_ (.A1(A[1]),
    .A2(B[5]),
    .A3(_103_),
    .B1(_155_),
    .X(_156_));
 sky130_fd_sc_hd__nand2_2 _481_ (.A(A[0]),
    .B(B[7]),
    .Y(_157_));
 sky130_fd_sc_hd__nand2_2 _482_ (.A(A[1]),
    .B(B[6]),
    .Y(_158_));
 ...
 sky130_fd_sc_hd__a21oi_2 _492_ (.A1(_165_),
    ...
    .B1(_167_),
    .Y(_168_));
 sky130_fd_sc_hd__and3_2 _493_ (.A(_167_),
    .B(_165_),
    .C(_166_),
    .X(_169_));
 ...
 sky130_fd_sc_hd__o21ai_2 _495_ (.A1(_168_),
    ...
    .B1(_141_),
    .Y(_171_));
 sky130_fd_sc_hd__and3_2 _496_ (.A(_115_),
    .B(_170_),
    .C(_171_),
    .X(_172_));
 sky130_fd_sc_hd__a21oi_2 _497_ (.A1(_170_),
    ...
    .B1(_115_),
    .Y(_173_));
 sky130_fd_sc_hd__o21a_2 _498_ (.A1(_172_),
    .A2(_173_),
    .B1(_189_),
    .X(_174_));
 sky130_fd_sc_hd__o21ai_2 _499_ (.A1(A[7]),
    .A2(B[7]),
    .B1(_198_),
    .Y(_175_));
 sky130_fd_sc_hd__o221a_2 _500_ (.A1(_187_),
    ...
    .C1(_181_),
    .X(_177_));
 sky130_fd_sc_hd__nand2_2 _501_ (.A(_175_),
    .B(_177_),
    .Y(_178_));
 sky130_fd_sc_hd__inv_2 _502_ (.A(A[7]),
    .Y(_179_));

module alu (A,
 ...
 sky130_fd_sc_hd__or2_1 _250_ (.A(net19),
    .B(_180_),
    .X(_181_));
 sky130_fd_sc_hd__clkbuf_4 _251_ (.A(net9),
    .X(_182_));
 ...
 sky130_fd_sc_hd__buf_2 _288_ (.A(net3),
    .X(_217_));
 sky130_fd_sc_hd__clkbuf_4 _289_ (.A(net11),
    .X(_218_));
 ...
 sky130_fd_sc_hd__o21a_1 _303_ (.A1(_229_),
    ...
    .B1(_203_),
    .X(_232_));
 sky130_fd_sc_hd__nand2_1 _304_ (.A(net3),
    .B(net11),
    .Y(_233_));
 ...
 sky130_fd_sc_hd__xor2_1 _381_ (.A(_053_),
    .B(_058_),
    .X(_059_));
 sky130_fd_sc_hd__nand4_1 _382_ (.A(_182_),
    .B(_196_),
    .C(_019_),
    .D(net6),
    .Y(_060_));

module ZeroToFiveCounter (clk,
 ...
 sky130_fd_sc_hd__buf_2 _194_ (.A(_086_),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__xnor2_1 _195_ (.A(\num[0] ),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand3_1 _266_ (.A(\count[17] ),
    ...
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__o211a_1 _267_ (.A1(\count[18] ),
    .A2(_137_),
    .B1(_140_),
    .C1(_087_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _286_ (.A(_154_),
    ...
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__o211a_1 _287_ (.A1(\count[23] ),
    .A2(_151_),
    .B1(_155_),
    .C1(_087_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _292_ (.A(\count[25] ),
    ...
    .VPWR(VPWR),
    .Y(_159_));
 sky130_fd_sc_hd__o211a_1 _293_ (.A1(\count[25] ),
    .A2(_156_),
    .B1(_159_),
    .C1(_087_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _341_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\num[2] ));
 sky130_fd_sc_hd__dfrtp_1 _342_ (.CLK(clk),
    .D(_000_),
    .RESET_B(_031_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\count[0] ));
 sky130_fd_sc_hd__dfrtp_1 _343_ (.CLK(clk),
    .D(_011_),
    .RESET_B(_032_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _347_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(\count[5] ));
 sky130_fd_sc_hd__dfrtp_1 _348_ (.CLK(clk),
    .D(_024_),
    .RESET_B(_037_),
    .VGND(VGND),
    .VNB(VGND),

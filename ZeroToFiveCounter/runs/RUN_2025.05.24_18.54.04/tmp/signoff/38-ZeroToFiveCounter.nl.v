module ZeroToFiveCounter (clk,
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_10_110 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_10_90 ();
 sky130_fd_sc_hd__decap_8 FILLER_0_11_124 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_14_44 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_18_36 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_1_67 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_2_71 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_3_42 ();
 ...
 sky130_fd_sc_hd__and2b_1 _167_ (.A_N(\num[2] ),
    .B(\num[1] ),
    .X(_062_));
 sky130_fd_sc_hd__inv_2 _168_ (.A(net12),
    .Y(_063_));
 sky130_fd_sc_hd__or4b_2 _169_ (.A(\count[25] ),
    ...
    .D_N(\count[24] ),
    .X(_064_));
 sky130_fd_sc_hd__or2_1 _170_ (.A(\count[8] ),
    .B(\count[10] ),
    .X(_065_));
 sky130_fd_sc_hd__or3_1 _171_ (.A(\count[12] ),
    .B(\count[9] ),
    .C(\count[11] ),
    .X(_066_));
 sky130_fd_sc_hd__nand3_1 _172_ (.A(\count[15] ),
    .B(\count[14] ),
    .C(\count[13] ),
    .Y(_067_));
 sky130_fd_sc_hd__o21ba_1 _173_ (.A1(_065_),
    .A2(_066_),
    .B1_N(_067_),
    .X(_068_));
 sky130_fd_sc_hd__and2_1 _174_ (.A(\count[16] ),
    .B(\count[18] ),
    .X(_069_));
 sky130_fd_sc_hd__and4_1 _175_ (.A(\count[23] ),
    .B(\count[22] ),
    .C(\count[21] ),
    .D(\count[20] ),
    .X(_070_));
 sky130_fd_sc_hd__or4bb_1 _176_ (.A(\count[17] ),
    .B(\count[19] ),
    .C_N(_069_),
    .D_N(_070_),
    .X(_071_));
 sky130_fd_sc_hd__a211o_1 _177_ (.A1(\count[17] ),
    .A2(\count[18] ),
    .B1(\count[19] ),
    .C1(_069_),
    .X(_072_));
 sky130_fd_sc_hd__o211a_1 _178_ (.A1(_068_),
    .A2(_071_),
    .B1(_070_),
    .C1(_072_),
    .X(_073_));
 sky130_fd_sc_hd__o21a_1 _179_ (.A1(\count[24] ),
    .A2(\count[25] ),
    .B1(\count[26] ),
    .X(_074_));
 sky130_fd_sc_hd__o22ai_4 _180_ (.A1(_064_),
    .A2(_073_),
    .B1(_074_),
    .B2(\count[27] ),
    .Y(_075_));
 sky130_fd_sc_hd__and4_2 _181_ (.A(\count[3] ),
    ...
    .D(\count[0] ),
    .X(_076_));
 sky130_fd_sc_hd__and4_1 _182_ (.A(\count[7] ),
    .B(\count[6] ),
    .C(\count[5] ),
    .D(\count[4] ),
    .X(_077_));
 sky130_fd_sc_hd__nand2_1 _183_ (.A(_076_),
    .B(_077_),
    .Y(_078_));
 sky130_fd_sc_hd__or3_1 _184_ (.A(_065_),
    .B(_066_),
    .C(_067_),
    .X(_079_));
 sky130_fd_sc_hd__or4_1 _185_ (.A(_064_),
    .B(_071_),
    .C(_078_),
    .D(_079_),
    .X(_080_));
 sky130_fd_sc_hd__a21bo_1 _186_ (.A1(_075_),
    .A2(_080_),
    .B1_N(\num[0] ),
    .X(_081_));
 sky130_fd_sc_hd__mux2_1 _187_ (.A0(_062_),
    .A1(\num[2] ),
    .S(_081_),
    .X(_082_));
 sky130_fd_sc_hd__clkbuf_1 _188_ (.A(_082_),
    .X(_061_));
 sky130_fd_sc_hd__or2b_1 _189_ (.A(\num[2] ),
    .B_N(\num[0] ),
    .X(_083_));
 sky130_fd_sc_hd__a21oi_1 _190_ (.A1(_075_),
    .A2(_080_),
    .B1(_083_),
    .Y(_084_));
 sky130_fd_sc_hd__mux2_1 _191_ (.A0(_084_),
    .A1(_081_),
    .S(\num[1] ),
    .X(_085_));
 sky130_fd_sc_hd__clkbuf_1 _192_ (.A(_085_),
    .X(_060_));
 sky130_fd_sc_hd__and2_1 _193_ (.A(_075_),
    .B(_080_),
    .X(_086_));
 sky130_fd_sc_hd__buf_2 _194_ (.A(_086_),
    .X(_087_));
 sky130_fd_sc_hd__xnor2_1 _195_ (.A(net13),
    .B(_087_),
    .Y(_059_));
 sky130_fd_sc_hd__and2b_1 _196_ (.A_N(\count[0] ),
    .B(_087_),
    .X(_088_));
 sky130_fd_sc_hd__clkbuf_1 _197_ (.A(_088_),
    .X(_000_));
 sky130_fd_sc_hd__nand2_1 _198_ (.A(\count[1] ),
    .B(\count[0] ),
    .Y(_089_));
 sky130_fd_sc_hd__clkbuf_2 _199_ (.A(_086_),
    .X(_090_));
 sky130_fd_sc_hd__or2_1 _200_ (.A(\count[1] ),
    .B(\count[0] ),
    .X(_091_));
 sky130_fd_sc_hd__and3_1 _201_ (.A(_089_),
    .B(_090_),
    .C(_091_),
    .X(_092_));
 sky130_fd_sc_hd__clkbuf_1 _202_ (.A(_092_),
    .X(_011_));
 sky130_fd_sc_hd__nand3_1 _203_ (.A(\count[2] ),
    .B(\count[1] ),
    .C(\count[0] ),
    .Y(_093_));
 sky130_fd_sc_hd__a21o_1 _204_ (.A1(\count[1] ),
    .A2(\count[0] ),
    .B1(\count[2] ),
    .X(_094_));
 sky130_fd_sc_hd__and3_1 _205_ (.A(_093_),
    .B(_090_),
    .C(_094_),
    .X(_095_));
 sky130_fd_sc_hd__clkbuf_1 _206_ (.A(_095_),
    .X(_020_));
 sky130_fd_sc_hd__a31o_1 _207_ (.A1(\count[2] ),
    .A2(\count[1] ),
    .A3(\count[0] ),
    .B1(\count[3] ),
    .X(_096_));
 sky130_fd_sc_hd__and3b_1 _208_ (.A_N(_076_),
    .B(_090_),
    .C(_096_),
    .X(_097_));
 sky130_fd_sc_hd__clkbuf_1 _209_ (.A(_097_),
    .X(_021_));
 sky130_fd_sc_hd__nand2_1 _210_ (.A(\count[4] ),
    .B(_076_),
    .Y(_098_));
 sky130_fd_sc_hd__or2_1 _211_ (.A(\count[4] ),
    .B(_076_),
    .X(_099_));
 sky130_fd_sc_hd__and3_1 _212_ (.A(_098_),
    .B(_090_),
    .C(_099_),
    .X(_100_));
 sky130_fd_sc_hd__clkbuf_1 _213_ (.A(_100_),
    .X(_022_));
 sky130_fd_sc_hd__and3_1 _214_ (.A(\count[5] ),
    .B(\count[4] ),
    .C(_076_),
    .X(_101_));
 sky130_fd_sc_hd__a21o_1 _215_ (.A1(\count[4] ),
    .A2(_076_),
    .B1(\count[5] ),
    .X(_102_));
 sky130_fd_sc_hd__and3b_1 _216_ (.A_N(_101_),
    .B(_090_),
    .C(_102_),
    .X(_103_));
 sky130_fd_sc_hd__clkbuf_1 _217_ (.A(_103_),
    .X(_023_));
 sky130_fd_sc_hd__nand2_1 _218_ (.A(\count[6] ),
    .B(_101_),
    .Y(_104_));
 sky130_fd_sc_hd__or2_1 _219_ (.A(\count[6] ),
    .B(_101_),
    .X(_105_));
 sky130_fd_sc_hd__and3_1 _220_ (.A(_075_),
    .B(_104_),
    .C(_105_),
    .X(_106_));
 sky130_fd_sc_hd__clkbuf_1 _221_ (.A(_106_),
    .X(_024_));
 sky130_fd_sc_hd__a21o_1 _222_ (.A1(\count[6] ),
    .A2(_101_),
    .B1(\count[7] ),
    .X(_107_));
 sky130_fd_sc_hd__and3_1 _223_ (.A(_075_),
    .B(_078_),
    .C(_107_),
    .X(_108_));
 sky130_fd_sc_hd__clkbuf_1 _224_ (.A(_108_),
    .X(_025_));
 sky130_fd_sc_hd__xnor2_1 _225_ (.A(\count[8] ),
    .B(_078_),
    .Y(_109_));
 sky130_fd_sc_hd__and3_1 _226_ (.A(_075_),
    ...
    .C(_109_),
    .X(_110_));
 sky130_fd_sc_hd__clkbuf_1 _227_ (.A(_110_),
    .X(_026_));
 sky130_fd_sc_hd__and4_1 _228_ (.A(\count[9] ),
    .B(\count[8] ),
    .C(_076_),
    .D(_077_),
    .X(_111_));
 sky130_fd_sc_hd__a31o_1 _229_ (.A1(\count[8] ),
    .A2(_076_),
    .A3(_077_),
    .B1(\count[9] ),
    .X(_112_));
 sky130_fd_sc_hd__and3b_1 _230_ (.A_N(_111_),
    .B(_112_),
    .C(_086_),
    .X(_113_));
 sky130_fd_sc_hd__clkbuf_1 _231_ (.A(_113_),
    .X(_027_));
 sky130_fd_sc_hd__and2_1 _232_ (.A(\count[10] ),
    .B(_111_),
    .X(_114_));
 sky130_fd_sc_hd__or2_1 _233_ (.A(\count[10] ),
    .B(_111_),
    .X(_115_));
 sky130_fd_sc_hd__and3b_1 _234_ (.A_N(_114_),
    .B(_090_),
    .C(_115_),
    .X(_116_));
 sky130_fd_sc_hd__clkbuf_1 _235_ (.A(_116_),
    .X(_001_));
 sky130_fd_sc_hd__or2_1 _236_ (.A(\count[11] ),
    .B(_114_),
    .X(_117_));
 sky130_fd_sc_hd__nand2_1 _237_ (.A(\count[11] ),
    .B(_114_),
    .Y(_118_));
 sky130_fd_sc_hd__and3_1 _238_ (.A(_087_),
    .B(_117_),
    .C(_118_),
    .X(_119_));
 sky130_fd_sc_hd__clkbuf_1 _239_ (.A(_119_),
    .X(_002_));
 sky130_fd_sc_hd__and4_1 _240_ (.A(\count[12] ),
    .B(\count[9] ),
    .C(\count[8] ),
    .D(\count[10] ),
    .X(_120_));
 sky130_fd_sc_hd__nand2_1 _241_ (.A(\count[11] ),
    .B(_120_),
    .Y(_121_));
 sky130_fd_sc_hd__nor2_1 _242_ (.A(_078_),
    .B(_121_),
    .Y(_122_));
 sky130_fd_sc_hd__a31o_1 _243_ (.A1(\count[11] ),
    .A2(\count[10] ),
    .A3(_111_),
    .B1(\count[12] ),
    .X(_123_));
 sky130_fd_sc_hd__and3b_1 _244_ (.A_N(_122_),
    .B(_090_),
    .C(_123_),
    .X(_124_));
 sky130_fd_sc_hd__clkbuf_1 _245_ (.A(_124_),
    .X(_003_));
 sky130_fd_sc_hd__nand2_1 _246_ (.A(\count[13] ),
    .B(_122_),
    .Y(_125_));
 sky130_fd_sc_hd__or2_1 _247_ (.A(\count[13] ),
    .B(_122_),
    .X(_126_));
 sky130_fd_sc_hd__and3_1 _248_ (.A(_087_),
    .B(_125_),
    .C(_126_),
    .X(_127_));
 sky130_fd_sc_hd__clkbuf_1 _249_ (.A(_127_),
    .X(_004_));
 sky130_fd_sc_hd__inv_2 _250_ (.A(\count[14] ),
    .Y(_128_));
 sky130_fd_sc_hd__nand2_1 _251_ (.A(_128_),
    .B(_125_),
    .Y(_129_));
 sky130_fd_sc_hd__o211a_1 _252_ (.A1(_128_),
    .A2(_125_),
    .B1(_129_),
    .C1(_087_),
    .X(_005_));
 sky130_fd_sc_hd__nor3_1 _253_ (.A(_067_),
    .B(_078_),
    .C(_121_),
    .Y(_130_));
 sky130_fd_sc_hd__buf_2 _254_ (.A(_130_),
    .X(_131_));
 sky130_fd_sc_hd__a31o_1 _255_ (.A1(\count[14] ),
    .A2(\count[13] ),
    .A3(_122_),
    .B1(\count[15] ),
    .X(_132_));
 sky130_fd_sc_hd__and3b_1 _256_ (.A_N(_131_),
    .B(_090_),
    .C(_132_),
    .X(_133_));
 sky130_fd_sc_hd__clkbuf_1 _257_ (.A(_133_),
    .X(_006_));
 sky130_fd_sc_hd__or2_1 _258_ (.A(\count[16] ),
    .B(_131_),
    .X(_134_));
 sky130_fd_sc_hd__nand2_1 _259_ (.A(\count[16] ),
    .B(_131_),
    .Y(_135_));
 sky130_fd_sc_hd__and3_1 _260_ (.A(_087_),
    .B(_134_),
    .C(_135_),
    .X(_136_));
 sky130_fd_sc_hd__clkbuf_1 _261_ (.A(_136_),
    .X(_007_));
 sky130_fd_sc_hd__and3_1 _262_ (.A(\count[16] ),
    .B(\count[17] ),
    .C(_131_),
    .X(_137_));
 sky130_fd_sc_hd__a21o_1 _263_ (.A1(\count[16] ),
    .A2(_131_),
    .B1(\count[17] ),
    .X(_138_));
 sky130_fd_sc_hd__and3b_1 _264_ (.A_N(_137_),
    .B(_090_),
    .C(_138_),
    .X(_139_));
 sky130_fd_sc_hd__clkbuf_1 _265_ (.A(_139_),
    .X(_008_));
 sky130_fd_sc_hd__nand3_1 _266_ (.A(\count[17] ),
    .B(_069_),
    .C(_131_),
    .Y(_140_));
 sky130_fd_sc_hd__o211a_1 _267_ (.A1(net11),
    .A2(_137_),
    .B1(_140_),
    .C1(_087_),
    .X(_009_));
 sky130_fd_sc_hd__and3_1 _268_ (.A(\count[17] ),
    .B(\count[19] ),
    .C(_069_),
    .X(_141_));
 sky130_fd_sc_hd__and2_1 _269_ (.A(_131_),
    .B(_141_),
    .X(_142_));
 sky130_fd_sc_hd__a31o_1 _270_ (.A1(\count[17] ),
    .A2(_069_),
    .A3(_131_),
    .B1(\count[19] ),
    .X(_143_));
 sky130_fd_sc_hd__and3b_1 _271_ (.A_N(_142_),
    .B(_086_),
    .C(_143_),
    .X(_144_));
 sky130_fd_sc_hd__clkbuf_1 _272_ (.A(_144_),
    .X(_010_));
 sky130_fd_sc_hd__or2_1 _273_ (.A(\count[20] ),
    .B(_142_),
    .X(_145_));
 sky130_fd_sc_hd__nand2_1 _274_ (.A(\count[20] ),
    .B(_142_),
    .Y(_146_));
 sky130_fd_sc_hd__and3_1 _275_ (.A(_090_),
    .B(_145_),
    .C(_146_),
    .X(_147_));
 sky130_fd_sc_hd__clkbuf_1 _276_ (.A(_147_),
    .X(_012_));
 sky130_fd_sc_hd__and4_1 _277_ (.A(\count[21] ),
    .B(\count[20] ),
    .C(_130_),
    .D(_141_),
    .X(_148_));
 sky130_fd_sc_hd__a31o_1 _278_ (.A1(\count[20] ),
    .A2(_131_),
    .A3(_141_),
    .B1(\count[21] ),
    .X(_149_));
 sky130_fd_sc_hd__and3b_1 _279_ (.A_N(_148_),
    .B(_086_),
    .C(_149_),
    .X(_150_));
 sky130_fd_sc_hd__clkbuf_1 _280_ (.A(_150_),
    .X(_013_));
 sky130_fd_sc_hd__and2_1 _281_ (.A(\count[22] ),
    .B(_148_),
    .X(_151_));
 sky130_fd_sc_hd__or2_1 _282_ (.A(\count[22] ),
    .B(_148_),
    .X(_152_));
 sky130_fd_sc_hd__and3b_1 _283_ (.A_N(_151_),
    .B(_086_),
    .C(_152_),
    .X(_153_));
 sky130_fd_sc_hd__clkbuf_1 _284_ (.A(_153_),
    .X(_014_));
 sky130_fd_sc_hd__and3_1 _285_ (.A(_070_),
    .B(_130_),
    .C(_141_),
    .X(_154_));
 sky130_fd_sc_hd__inv_2 _286_ (.A(_154_),
    .Y(_155_));
 sky130_fd_sc_hd__o211a_1 _287_ (.A1(net10),
    .A2(_151_),
    .B1(_155_),
    .C1(_087_),
    .X(_015_));
 sky130_fd_sc_hd__and4_1 _288_ (.A(\count[24] ),
    .B(_070_),
    .C(_131_),
    .D(_141_),
    .X(_156_));
 sky130_fd_sc_hd__or2_1 _289_ (.A(\count[24] ),
    .B(_154_),
    .X(_157_));
 sky130_fd_sc_hd__and3b_1 _290_ (.A_N(_156_),
    .B(_086_),
    .C(_157_),
    .X(_158_));
 sky130_fd_sc_hd__clkbuf_1 _291_ (.A(_158_),
    .X(_016_));
 sky130_fd_sc_hd__nand2_1 _292_ (.A(\count[25] ),
    .B(_156_),
    .Y(_159_));
 sky130_fd_sc_hd__o211a_1 _293_ (.A1(net14),
    .A2(_156_),
    .B1(_159_),
    .C1(_087_),
    .X(_017_));
 sky130_fd_sc_hd__a21boi_1 _294_ (.A1(_063_),
    .A2(_159_),
    .B1_N(_087_),
    .Y(_018_));
 sky130_fd_sc_hd__or2b_1 _295_ (.A(\num[1] ),
    .B_N(\num[0] ),
    .X(_160_));
 sky130_fd_sc_hd__a2bb2o_1 _296_ (.A1_N(\num[1] ),
    .A2_N(_083_),
    .B1(_160_),
    .B2(\num[2] ),
    .X(net5));
 sky130_fd_sc_hd__o21a_1 _297_ (.A1(\num[1] ),
    .A2(\num[0] ),
    .B1(\num[2] ),
    .X(net3));
 sky130_fd_sc_hd__and2_1 _298_ (.A(\num[1] ),
    .B(_083_),
    .X(_161_));
 sky130_fd_sc_hd__clkbuf_1 _299_ (.A(_161_),
    .X(net4));
 sky130_fd_sc_hd__or2_1 _300_ (.A(\num[2] ),
    .B(\num[0] ),
    .X(_162_));
 sky130_fd_sc_hd__clkbuf_1 _301_ (.A(_162_),
    .X(net6));
 sky130_fd_sc_hd__or2b_1 _302_ (.A(\num[1] ),
    .B_N(_083_),
    .X(_163_));
 sky130_fd_sc_hd__clkbuf_1 _303_ (.A(_163_),
    .X(net7));
 sky130_fd_sc_hd__xnor2_1 _304_ (.A(\num[2] ),
    .B(\num[1] ),
    .Y(net8));
 sky130_fd_sc_hd__buf_4 _305_ (.A(net1),
    .X(_164_));
 ...
 sky130_fd_sc_hd__inv_2 _337_ (.A(_166_),
    .Y(_057_));
 sky130_fd_sc_hd__inv_2 _338_ (.A(net1),
    .Y(_058_));
 ...
 sky130_fd_sc_hd__dfrtp_1 _346_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .RESET_B(_035_),
    .Q(\count[4] ));
 sky130_fd_sc_hd__dfrtp_1 _347_ (.CLK(clknet_2_1__leaf_clk),
    .D(_023_),
    .RESET_B(_036_),
    .Q(\count[5] ));
 sky130_fd_sc_hd__dfrtp_1 _348_ (.CLK(clknet_2_1__leaf_clk),
    .D(_024_),
    .RESET_B(_037_),
    .Q(\count[6] ));
 sky130_fd_sc_hd__dfrtp_1 _349_ (.CLK(clknet_2_1__leaf_clk),
    .D(_025_),
    .RESET_B(_038_),
    .Q(\count[7] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _354_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .RESET_B(_043_),
    .Q(\count[12] ));
 sky130_fd_sc_hd__dfrtp_1 _355_ (.CLK(clknet_2_2__leaf_clk),
    .D(_004_),
    .RESET_B(_044_),
    .Q(\count[13] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _369_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .RESET_B(_058_),
    .Q(\count[27] ));
 sky130_fd_sc_hd__conb_1 _369__9 (.LO(net9));
 sky130_fd_sc_hd__clkbuf_1 _371_ (.A(net5),
    .X(net2));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold1 (.A(\count[23] ),
    .X(net10));
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(\count[18] ),
    .X(net11));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(\count[26] ),
    .X(net12));
 sky130_fd_sc_hd__dlygate4sd3_1 hold4 (.A(\num[0] ),
    .X(net13));
 sky130_fd_sc_hd__dlygate4sd3_1 hold5 (.A(\count[25] ),
    .X(net14));
